...
class FactographFactCheckingSiteExtractor(FactCheckingSiteExtractor):
    """
    A class that extracts fact-checking claims and related information from the Factograph website.
    """

    def __init__(self, configuration: Configuration):
        """
        Initialize the FactographFactCheckingSiteExtractor.
    ...
    def retrieve_listing_page_urls(self) -> List[str]:
        ...
        return ["https://www.factograph.info/z/20894"]
