...
Collection of data from promiment fact-checking websites for the purpose of fake news and misinformation spread

Data Collection and webscraping for claim detection and analysis
...
### Sample Input 
The method performs web scraping, so input should be the name of the website intended for web data collection
### Sample Output
